      ...
      <div className={tw(`container mx-auto px-6 p-6 bg-white`)}>
        ...
        <div className={tw(`flex flex-wrap my-12`)}>
          <div className={tw(`w-full border-b md:w-1/2 md:border-r lg:w-1/3 p-8`)}>
            ...
            <p className={tw(`leading-loose text-gray-500`)}>Get higher sales</p>
          </div>
          <div className={tw(`w-full border-b md:w-1/2 lg:w-1/3 lg:border-r p-8`)}>
            ...
            <p className={tw(`leading-loose text-gray-500 `)}>Flexible and work for every organization</p>
          </div>
          <div className={tw(`w-full border-b md:w-1/2 md:border-r lg:w-1/3 lg:border-r-0 p-8`)}>
            ...
            <p className={tw(`leading-loose text-gray-500`)}>Unlimited reach with influencers</p>
          </div>
          <div className={tw(`w-full border-b md:w-1/2 lg:w-1/3 lg:border-r lg:border-b-0 p-8`)}>
            ...
            <p className={tw(`leading-loose text-gray-500`)}>Recommended by experts</p>
          </div>
          <div className={tw(`w-full border-b md:w-1/2 md:border-r md:border-b-0 lg:w-1/3 lg:border-b-0 p-8`)}>
            ...
            <p className={tw(`leading-loose text-gray-500`)}>Modern platform with agile support</p>
          </div>
          <div className={tw(`w-full md:w-1/2 lg:w-1/3 p-8`)}>
            ...
            <p className={tw(`leading-loose text-gray-500`)}>multiple integrations</p>
          </div>
        </div>
      </div>
    </div>
